...
from app.inputvalidators import InputValidator
...
class Calculator:
    ...
    def __init__(self, config: Optional[CalculatorConfig] = None):
        ...
        logging.info("Calculator successfully initialized")
    ...
    def _setup_logging(self) -> None:
        try:
            ...
            logging.info(f"Logger initialized and writing to: {log_file}")
    ...
    def perform_operation(self,
                          a: Union[str, Number],
                          b: Union[str, Number]) -> CalculationResult:
    ...
    def save_history(self) -> None:
        ...
        try:
            ...
            for calc in self.history:
                history_data.append({
                    'operation': str(calc.operation_type),
            ...
            if history_data:
                ...
                logging.info("Empty history file saved")

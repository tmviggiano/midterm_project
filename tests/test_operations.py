...
class TestRoot(BaseOperationTest):
    ...
    invalid_test_cases = {
        "negative_base": {
            ...
            "b": "2",
            "error": ValidationError,
            "message": "Cannot take the root of a negative number"
        },
        "zero_root": {
            "a": "9",
            "b": "0",
            "error": ValidationError,
            "message": "Zeroth root is undefined"
        },
    }
...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "6", "b": "4", "expected": "2"},
...
class TestIntDivision(BaseOperationTest):
    """Test IntDivision operation."""

    operation_class = Integer_Division
    valid_test_cases = {
        "positive_numbers": {"a": "6.6", "b": "2", "expected": "3"},
        "negative_numbers": {"a": "-6.6", "b": "-2", "expected": "3"},
        "mixed_signs": {"a": "-6.6", "b": "2", "expected": "-3"},
...
class TestAbsDiff(BaseOperationTest):
    """Test AbsDiff operation."""

    operation_class = Absolute_Difference
    valid_test_cases = {
